...
function ToastItem({ toast, onClose }: ToastItemProps) {
  return (
    <div
      className={`flex items-center gap-3 rounded-lg border px-4 py-3 shadow-lg animate-in slide-in-from-right-full duration-300 ${stylesByType[toast.type]}`}
      role="alert"
    >
      ...
      <button
        onClick={onClose}
        className="ml-2 flex-shrink-0 rounded p-1 hover:bg-black/10 dark:hover:bg-white/10"
        aria-label="Dismiss"
      >
